...
import { AgentBureauCourrierRoutingModule } from "./agent-bureau-courrier-routing.module";
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    AgentBureauCourrierRoutingModule,
    ComponentsModule,
    SharedModule,
    MatTableModule,
    MatPaginatorModule,
  ...
  providers: [AdvanceTableEntrantService, AdvanceTableSortantService, AdvanceTableTraiteService, AdvanceTableArchiveService],
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class AgentBureauCourrierModule {}
