...
import { FormDialogArchiveComponent } from './dialogs/form-dialog/form-dialog.component';
import { DeleteDialogArchiveComponent } from './dialogs/delete/delete.component';
  ...
  implements OnInit
{
  ...
  exampleDatabase: AdvanceTableArchiveService | null;
  ...
  addNew() {
    ...
    const dialogRef = this.dialog.open(FormDialogArchiveComponent, {
      data: {
  ...
  deleteItem(row) {
    ...
    const dialogRef = this.dialog.open(DeleteDialogArchiveComponent, {
      data: row,
      direction: tempDirection
    });
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
  ...
  public loadData() {
    this.exampleDatabase = this.advanceTableService;
...
export class ExampleDataSource extends DataSource<AdvanceTable> {
  ...
  constructor(
    public exampleDatabase: AdvanceTableArchiveService,
