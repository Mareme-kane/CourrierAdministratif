...
import { FormDialogTraiteComponent } from './dialogs/form-dialog/form-dialog.component';
import { DeleteDialogTraiteComponent } from './dialogs/delete/delete.component';

@Component({
  selector: 'app-advance-table-traite',
  templateUrl: './advance-table.component.html',
  styleUrls: ['./advance-table.component.sass'],
  providers: [{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }]
})
export class AdvanceTableTraiteComponent
  ...
  implements OnInit
{
  ...
  exampleDatabase: AdvanceTableTraiteService | null;
  ...
  addNew() {
    ...
    const dialogRef = this.dialog.open(FormDialogTraiteComponent, {
      data: {
  ...
  deleteItem(row) {
    ...
    const dialogRef = this.dialog.open(DeleteDialogTraiteComponent, {
      data: row,
      direction: tempDirection
    });
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
  ...
  public loadData() {
    this.exampleDatabase = new AdvanceTableTraiteService(this.httpClient);
...
export class ExampleDataSource extends DataSource<AdvanceTable> {
  ...
  constructor(
    public exampleDatabase: AdvanceTableTraiteService,
