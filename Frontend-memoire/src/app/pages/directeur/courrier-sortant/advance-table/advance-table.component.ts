...
import { FormDialogSortantComponent } from './dialogs/form-dialog/form-dialog.component';
import { DeleteDialogSortantComponent } from './dialogs/delete/delete.component';
  ...
  implements OnInit
{
  ...
  exampleDatabase: AdvanceTableSortantService | null;
  ...
  addNew() {
    ...
    const dialogRef = this.dialog.open(FormDialogSortantComponent, {
      data: {
  ...
  deleteItem(row) {
    ...
    const dialogRef = this.dialog.open(DeleteDialogSortantComponent, {
      data: row,
      direction: tempDirection
    });
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
  ...
  public loadData() {
    this.exampleDatabase = new AdvanceTableSortantService(this.httpClient);
...
export class ExampleDataSource extends DataSource<AdvanceTable> {
  ...
  constructor(
    public exampleDatabase: AdvanceTableSortantService,
